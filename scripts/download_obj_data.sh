...
wget -O ndf_obj_assets.tar.gz https://www.dropbox.com/s/831szjnb8l7gbdh/ndf_obj_assets.tar.gz?dl=0 --no-check-certificate
...
cd $NDF_SOURCE_DIR
wget -O ndf_other_assets.tar.gz https://www.dropbox.com/s/fopyjjm3fpc3k7i/ndf_other_assets.tar.gz?dl=0 --no-check-certificate
