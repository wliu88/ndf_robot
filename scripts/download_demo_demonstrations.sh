...
wget -O ndf_release_demo_demonstrations.tar.gz https://www.dropbox.com/s/rcnkzkrd0gyvvxh/ndf_release_demo_demonstrations.tar.gz?dl=0 --no-check-certificate
